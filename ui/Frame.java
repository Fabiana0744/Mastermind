...
public class Frame extends JFrame{
	...
	public void close() {
		...
		int opcion = JOptionPane.showOptionDialog(this, "Sus turnos se han terminado. ¿Desea jugar de nuevo?", "Select an option", 0, 0, null, boton, this);
	...
	public void victory(boolean pIsVictory) {
		...
		int opcion = JOptionPane.showOptionDialog(this, "¡Felicidades, has ganado! ¿Desea jugar de nuevo?", "Select an option", 0, 0, null, boton, this);
